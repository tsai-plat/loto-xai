...
import { SseMessageChunkData, SseMessageType, XAI_SSE_MESSAGE_STOP_VALUE } from "../../chat/sse-types"
import { EventStreamContentType, globalFetch } from "./index"
import { FetchMethod, IXaiStreamCache, SseCallbackFn, SseEventType, StreamablePrepareCallback, XaiStreamableOptions, XaiStreamableRequestData, XaiStreamCompleteData } from "./streamable.types"
import {SseFetchError} from './streamable.error'
import { SSE_ERROE_CODE } from "../../error/xai-error.codes"
import { getBytes, getLines, SSEContolChars } from "./streamable.parser"
import { XaiError } from "../../error/xai-error"
import { calcCostTime, createChatMessageId, createRequestId } from "../../utils"
 ...
 *
 */
export class XaiSseFetch {
  private checkAuth = true
  protected debug: boolean = false
  protected eventDataParsed = false
   ...
   * @param options
   */
  private _registListeners(options: XaiStreamableOptions & { eventDataParsed?: boolean }) {
    const {
      checkAuth,
      eventDataParsed,
      apiBasePrefix,
